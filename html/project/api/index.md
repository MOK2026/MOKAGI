...
> **api.js**：https://64071181.xyz/static/api.js
...
```html
<script src="https://64071181.xyz/static/api.js"></script>
```
...
<body>
  ...
  <script>
    ...
    window.MOKAGI_SERVER     = "https://64071181.xyz";
...
1. 在 `</body>` 前加入 `<script src="https://64071181.xyz/static/api.js"></script>`
